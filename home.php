...
<div class="slidem">
        <img src=" ./images/mountains.gif"  class="slide-img" alt="" />
        <h1 class="explore">Life is Short and World is Wide</h1>
      </div>
      <div class="slidem">
        <img src="./images/waterfall.gif" class="slide-img" alt="" />
        <h1 class="explore">Explore India with Us</h1>
      </div>
      <div class="slidem">
        <img src="./images/forest-sun-rays.gif" 
        class="slide-img" alt="" />
        <h1 class="explore">Trust Our Experience</h1>
      </div>
      <div class="slidem">
          <img src="./images/Kerala-Houseboat.gif" class="slide-img" alt="" />
...
<section class="services">
  ...
  <div class="box-container">
    ...
    <div class="boxfire">
       <img src="./images/1000_F_203531238_SVMgzhcf0djtt2rupV6bHM2P6vn641HN.jpg" alt="">
        <h3>camp fire</h3>
    </div>
    
    <div class="boxboat">
       <img src="./images/sailing-boat.png" alt="">
        <h3>boating</h3>
    </div>

    <div class="boxcamp">
       <img src="./images/camping-zone.png" alt="">
       <h3>camping</h3>
    </div>  
